...
export default function AdminLogin() {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      login(response.data.access_token, 'admin')
          ...
          <div className="relative flex w-full flex-col justify-between p-10 xl:p-14">
            ...
            <div className="max-w-lg">
              ...
              <p className="mt-6 max-w-md text-sm leading-7 text-gray-500">
                Manage hackathon teams, problem statements, rounds,
                evaluators, and evaluation progress from one workspace.
              </p>
            </div>

            {/* Footer */}
            <p className="text-xs text-gray-600">
              HackOddsey • Admin Portal
            </p>
          </div>
        </div>
