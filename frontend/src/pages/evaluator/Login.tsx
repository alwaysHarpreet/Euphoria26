...
export default function EvaluatorLogin() {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      const response = await api.post('/evaluator/login', {
        email,
        password,
      })

      login(response.data.access_token, 'evaluator')
          ...
          <div className="relative flex w-full flex-col justify-between p-10 xl:p-14">
            ...
            <div className="max-w-lg">
              ...
              <p className="mt-6 max-w-md text-sm leading-7 text-gray-500">
                Access your evaluator workspace, review participating teams,
                submit round-wise scores, and help maintain a fair evaluation
                process.
              </p>
            </div>
          ...
          <div className="w-full max-w-[420px]">
            ...
            <div className="mt-8 border-t border-white/10 pt-6">
              ...
              <p className="text-center text-xs leading-5 text-gray-600">
                Evaluator access is restricted to authorized
                evaluator accounts.
              </p>
            </div>
